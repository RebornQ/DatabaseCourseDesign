...
////修复Permission为-1或1时?r=admin-list-normal仍可访问的问题
                        ...
                        <div class="am-cf">
                            ...
                            <div class="am-fr">
                                <ul class="am-pagination">
                                    ...
                                    echo "<li><a href='?r=admin-list-normal&page=1'>" . '|<' . "</a></li>"; // 第一页
                                    $page_forward = $page - 1;
                                    if ($page_forward > 0) {
                                        echo "<li><a href='?r=admin-list-normal&page=$page_forward'>«</a></li>";
                                    } else {
                                        echo "<li class=\"am-disabled\"><a href='?r=admin-list-normal&page=$page_forward'>«</a></li>";
                                    }
                                    for ($i = 1; $i <= $total_pages; $i++) {
                                        $page_current = "page_current$i";
                                        echo "<li id='$page_current'><a href='?r=admin-list-normal&page=" . $i . "'>" . $i . "</a></li> ";
                                        if ($page == $i) {
                                    ...
                                    if ($page_next <= $total_pages) {
                                        echo "<li><a href='?r=admin-list-normal&page={$page_next}'>»</a></li>";
                                    } else {
                                        echo "<li class=\"am-disabled\"><a href='?r=admin-list-normal&page=$page_next'>»</a></li>";
                                    }
                                    echo "<li><a href='?r=admin-list-normal&page=$total_pages'>" . '>|' . "</li> "; // 最后一页
                                    ?>
                                </ul>
                            </div>
                        </div>
